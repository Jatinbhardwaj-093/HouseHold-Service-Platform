...
const submitForm = async () => {
    try {
        const response = await axios.put(
            'http://127.0.0.1:5000/professional/profile',
            professional.value,
            {
                headers: {
...
<template>
    <div class="editModal-content">
        <form class="form" @submit.prevent="submitForm">
            ...
            <input type="email" class="email" v-model="professional.email" id="email" />

            <label for="username" class="label">Username</label>
            <input type="text" class="username" v-model="professional.username" id="username" />

            <label for="password" class="label">Password</label>
            <input type="password" class="password" v-model="professional.password" id="password" />

            <label for="experience" class="label">Experience (Years)</label>
            <input type="number" class="experience" v-model="professional.experience" id="experience" />

            <label for="contact" class="label">Contact</label>
            <input type="number" class="contact" v-model="professional.contact" id="contact" />

            <label for="pincode" class="label">Pincode</label>
            <input type="number" class="pincode" v-model="professional.pincode" id="pincode" />
